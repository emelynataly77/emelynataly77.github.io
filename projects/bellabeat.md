...
<li><span style="color:gray;">`dailyActivity_merged.csv` → style="color:gray;">`dailyActivity.csv`  
<li><span style="color:gray;">`sleepDay_merged.csv` → style="color:gray;">`sleepDay.csv`  
<li><span style="color:gray;">`hourlyCalories_merged.csv` → style="color:gray;">`hourlyCalories.csv`  
<li><span style="color:gray;">`hourlyIntensities_merged.csv` → style="color:gray;">`hourlyIntensities.csv`  
<li><span style="color:gray;">`hourlySteps_merged.csv` → style="color:gray;">`hourlySteps.csv`
